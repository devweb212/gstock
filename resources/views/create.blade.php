   ...
   <div class="main-card mb-3 card">
      <div class="card-body">
         ...
         <form action="/savepieces" method="post" class="needs-validation" novalidate>
            ...
            <div class="form-row">
               <div class="col-md-4 mb-3">
                  <label for="validationCustom03">N° BL</label>
                  <input type="text" class="form-control" id="validationCustom03" placeholder="N° BL" name="bl" required>
                 
               </div>
               <div class="col-md-4 mb-3">
                  <label for="validationCustom04">Fournisseur</label>
                  <input type="text" class="form-control" id="validationCustom04" placeholder="Fournisseur" name="forn" required>
               ...
               <div class="col-md-4 mb-3">
                  <div class="card-body">
                     <fieldset class="position-relative form-group">
						...
						<input name="typeb" type="hidden" value="1"> 
                   
                     </fieldset>
                  </div>
               </div>
            </div>
            <button class="btn btn-primary" type="submit">Ajouter un Entrée</button>
         </form>
         <script>
