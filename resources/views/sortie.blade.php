...
<input type="text" class="form-control" id="validationCustom02" placeholder="Quantité" value="" name="quan[]" required>
	...
	<select  id="sortie" name="des" data-placeholder="selectionner une Destinataire..." class="chosen-select select2 mb-2 form-control-lg form-control"    tabindex="4" required>							   
									<?php
									$i=0;
			...
			<select  name="transport" data-placeholder="Selectionner un code Matériel..." class="chosen-select select2 mb-2 form-control-lg form-control"    tabindex="4" required>							   
									<?php
									$i=0;
									foreach($materielarray as $item){
									foreach($item as $key){
									...
									<option value="50151010">Autre</option>
									 ...
									 <input type="hidden" class="form-control" id="validationCustom03" placeholder="Envoyé par" name="envoye" value="{{ Auth::user()->name }}">
										...
										<div class="col-md-4 mb-3">
                                         ...
                                         <input type="hidden" name="type_sortie" value="Vers Chantier ou Harbil">
